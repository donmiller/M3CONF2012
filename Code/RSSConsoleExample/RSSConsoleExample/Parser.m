...
{
	NSString *errorString = [NSString stringWithFormat:@"Unable to download movie feed from web site (Error code %li)", [parseError code]];
...
{
    NSLog(@"All done!");
    NSLog(@"Movies array has %li items", [movies count]);
}
